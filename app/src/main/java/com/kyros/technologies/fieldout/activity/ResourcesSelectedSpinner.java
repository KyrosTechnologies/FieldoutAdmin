...
public class ResourcesSelectedSpinner implements SpinnerAdapter, ListAdapter {
    ...
    public ResourcesSelectedSpinner(
    ...
    private ResourcesSelectedSpinner(SpinnerAdapter spinnerAdapter,
    ...
    private View getNothingSelectedView(ViewGroup parent) {
        ...
        try{
            TextView business_type_nature_text = (TextView) ((Activity) context).findViewById(R.id.tool_resources);
            store = PreferenceManager.getInstance(context);
            String bnature= store.getResourceNameSpinner();
