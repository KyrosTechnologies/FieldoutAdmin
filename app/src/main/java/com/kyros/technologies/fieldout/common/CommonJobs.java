...
public class CommonJobs {
    ...
    private String scheduledBeginDate;
    ...
    private String nmactivity;
    private String noteactivity;
    private String dtend;
    private String dtstart;
    private String dtreturned;
    ...
    private String idtoolsresources;
    private String toolsresname;
    ...
    public void setScheduledBeginDate(String scheduledBeginDate) {
    ...
    public void setNmactivity(String nmactivity) {
    ...
    public String getDtreturned() {
        return dtreturned;
    }

    public void setDtreturned(String dtreturned) {
    ...
    public String getIdtoolsresources() {
        return idtoolsresources;
    }

    public String getToolsresname() {
        return toolsresname;
    }

    public void setToolsresname(String toolsresname) {
        this.toolsresname = toolsresname;
    }

    public void setIdtoolsresources(String idtoolsresources) {
        this.idtoolsresources = idtoolsresources;
    ...
    public JSONArray getTaginfo() {
        return taginfo;
    }

    public void setTaginfo(JSONArray taginfo) {
