...
public class TechnicianDayClosed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (commonJobsArrayList.size()!=0){
                ...
                CompletedJobsAdapter completedJobsAdapter = new CompletedJobsAdapter(TechnicianDayClosed.this, commonJobsArrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                TechnicianDayClosed.this.finish();
                return true;
        }
