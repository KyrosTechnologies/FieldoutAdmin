...
public class TechnicianWeekAll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (commonJobsArrayList.size()!=0){
                ...
                CompletedJobsAdapter completedJobsAdapter = new CompletedJobsAdapter(TechnicianWeekAll.this, commonJobsArrayList);
