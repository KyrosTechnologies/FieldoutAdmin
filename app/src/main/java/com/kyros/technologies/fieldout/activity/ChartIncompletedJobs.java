...
import com.kyros.technologies.fieldout.adapters.IncompletedJobsAdapter;
...
public class ChartIncompletedJobs extends AppCompatActivity {
        ...
        try {
            ...
            if (index==0){
                if(commonJobsArrayList.size()!=0){
                    ...
                    IncompletedJobsAdapter incompletedJobsAdapter = new IncompletedJobsAdapter(ChartIncompletedJobs.this, commonJobsArrayList);
                    jobs_month_recycler.setAdapter(incompletedJobsAdapter);
                    incompletedJobsAdapter.notifyDataSetChanged();
                }
            }else if (index==1){
                if(commonJobsArrayList.size()!=0){
                    jobs_month_recycler = findViewById(R.id.jobs_month_recycler);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                ChartIncompletedJobs.this.finish();
                return true;
        }
