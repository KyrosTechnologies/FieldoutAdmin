...
public class IncompletedJobsAdapter extends RecyclerView.Adapter<IncompletedJobsAdapter.MyViewHolderEleven>{
    ...
    public IncompletedJobsAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public IncompletedJobsAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_month_jobs,parent,false);

        return new IncompletedJobsAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(IncompletedJobsAdapter.MyViewHolderEleven holder, int position) {
