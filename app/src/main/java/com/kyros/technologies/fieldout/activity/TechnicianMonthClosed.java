...
public class TechnicianMonthClosed extends AppCompatActivity {

    private PreferenceManager store;
    ArrayList<CommonJobs> commonJobsArrayList = new ArrayList<CommonJobs>();
    private RecyclerView jobs_month_recycler;
    private String techClosedJobs=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            techClosedJobs=bundle.getString("techClosedJobs");
        }catch (Exception e){
            e.printStackTrace();
        }

        try {
            JSONArray techallJobs=new JSONArray(techClosedJobs);
            ...
            if (commonJobsArrayList.size()!=0){
                ...
                CompletedJobsAdapter completedJobsAdapter = new CompletedJobsAdapter(TechnicianMonthClosed.this, commonJobsArrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                TechnicianMonthClosed.this.finish();
                return true;
        }
