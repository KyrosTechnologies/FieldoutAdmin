...
public class SiteJobsList extends AppCompatActivity {

    private PreferenceManager store;
    ArrayList<CommonJobs> commonJobsArrayList = new ArrayList<CommonJobs>();
    private RecyclerView jobs_month_recycler;
    private String sitejobs=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            sitejobs=bundle.getString("sitejobs");
        }catch (Exception e){
            e.printStackTrace();
        }

        try {
            JSONArray techallJobs=new JSONArray(sitejobs);
            ...
            if (commonJobsArrayList.size()!=0){
                ...
                CustomerJobsListAdapter customerJobsListAdapter = new CustomerJobsListAdapter(SiteJobsList.this, commonJobsArrayList);
