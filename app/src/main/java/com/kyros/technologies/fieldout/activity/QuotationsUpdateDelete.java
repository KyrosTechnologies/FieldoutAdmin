...
public class QuotationsUpdateDelete extends AppCompatActivity {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<array.length();i++){
                        ...
                        QuotationsUpdateDelete.this.cusid=customerid;
                    ...
                    ArrayAdapter<String> adapter=new  ArrayAdapter<String>(QuotationsUpdateDelete.this,android.R.layout.simple_spinner_item,
                            spinnerlist);
                    adapter.setDropDownViewResource(android.R.layout.simple_list_item_1);
                    incoices_customer_spinner.setPrompt("Customer");
                    incoices_customer_spinner.setAdapter(adapter);
                    incoices_customer_spinner.setAdapter(new SpinnerDetails(adapter,R.layout.customer,QuotationsUpdateDelete.this));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<array.length();i++){
                        ...
                        QuotationsUpdateDelete.this.siteid=siteid;
                    ...
                    incoices_site_spinner.setAdapter(new SpinnerDetails(adapter,R.layout.site,QuotationsUpdateDelete.this));
    ...
    private void showProgressDialog() {
        if (pDialog == null) {
            pDialog = new ProgressDialog(QuotationsUpdateDelete.this);
    ...
    private void QuotationsUpdateApi() {
        String tag_json_obj = "json_obj_req";
        String url = EndURL.URL+"quotations/update/"+quotationid;
        store= PreferenceManager.getInstance(getApplicationContext());
        Log.d("waggonurl", url);
        showProgressDialog();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        Intent i=new Intent(QuotationsUpdateDelete.this,AddQuotationsListActivity.class);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.DELETE, url, inputLogin, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    QuotationsUpdateDelete.this.finish();
...
//                texts.setText(error.toString());
    ...
    private void showDeleteDialog(){
        if(builder==null){
            builder = new AlertDialog.Builder(QuotationsUpdateDelete.this);
