...
import com.kyros.technologies.fieldout.activity.TechnicianDayAll;
import com.kyros.technologies.fieldout.activity.TechnicianDayClosed;
...
public class TechnicianDayAdapter extends RecyclerView.Adapter<TechnicianDayAdapter.MyViewHolderEleven>{
    ...
    public TechnicianDayAdapter(Context mContext,ArrayList<CommonJobs>duration){
    ...
    @Override
    public TechnicianDayAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_technician_progress_bar,parent,false);

        return new TechnicianDayAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(TechnicianDayAdapter.MyViewHolderEleven holder, int position) {
        ...
        JSONArray techalljobs=commonJobs.getDayAllJobs();
        JSONArray techClosedJobs=commonJobs.getDayClosedJobs();
            ...
            try {
                ...
                if (i==0){
                    ...
                    holder.jobs_count_tech_all.setOnClickListener(view -> {
                        Intent k=new Intent(mContext, TechnicianDayAll.class);
                    ...
                    holder.jobs_count_tech_closed.setOnClickListener(view -> {
                        Intent k=new Intent(mContext, TechnicianDayClosed.class);
