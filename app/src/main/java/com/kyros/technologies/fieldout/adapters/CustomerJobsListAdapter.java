...
public class CustomerJobsListAdapter extends RecyclerView.Adapter<CustomerJobsListAdapter.MyViewHolderEleven>{
    ...
    public CustomerJobsListAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public CustomerJobsListAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_month_jobs,parent,false);

        return new CustomerJobsListAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(CustomerJobsListAdapter.MyViewHolderEleven holder, int position) {
