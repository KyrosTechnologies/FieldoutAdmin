...
public class JobsDayDetails extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetTechnicianList();
        ((ServiceHandler)getApplication()).getApplicationComponent().injectJobsdayDetails(this);
        ...
        schedule_start_date.setOnClickListener(view -> {
            ...
            DatePickerDialog mDatePicker=new DatePickerDialog(JobsDayDetails.this, new DatePickerDialog.OnDateSetListener() {
...
//                mDatePicker.setTitle("Select date");
    ...
    private void starttimePicker(){
        ...
        timePickerDialog=new TimePickerDialog(JobsDayDetails.this, (timePicker, selectedHour, selectedMinute) -> onTimeSet(selectedHour,selectedMinute),hour,minute,false);
    ...
    private void endtimePicker(){
        ...
        int hour = mcurrentTime.get(Calendar.HOUR_OF_DAY);
        int minute = mcurrentTime.get(Calendar.MINUTE);
        endtimePickerDialog=new TimePickerDialog(JobsDayDetails.this, (timePicker, selectedHour, selectedMinute) -> onEndTimeSet(selectedHour,selectedMinute),hour,minute,false);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, url, (String)null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter=new  ArrayAdapter<String>(JobsDayDetails.this,android.R.layout.simple_spinner_item,
                            spinnerlist);
                    adapter.setDropDownViewResource(android.R.layout.simple_list_item_1);
                    technician_spinner.setPrompt("Technician");
                    technician_spinner.setAdapter(adapter);
                    technician_spinner.setAdapter(new SpinnerDetails(adapter,R.layout.technician,JobsDayDetails.this));
    ...
    private void showProgressDialog() {
        if (pDialog == null) {
            pDialog = new ProgressDialog(JobsDayDetails.this);
...
//                texts.setText(error.toString());
    ...
    private void showDeleteDialog(){
        if(builder==null){
            builder = new AlertDialog.Builder(JobsDayDetails.this);
