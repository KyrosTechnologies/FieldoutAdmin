...
import com.kyros.technologies.fieldout.adapters.StatusListAdapter;
...
public class StatusJobsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            statusindex=bundle.getString("statusindex");
        }catch (Exception e){
            e.printStackTrace();
        }

        try {
            JSONArray techallJobs=new JSONArray(statusindex);
            ...
            if (commonJobsArrayList.size()!=0){
                ...
                StatusListAdapter statusListAdapter = new StatusListAdapter(StatusJobsList.this, commonJobsArrayList);
                jobs_month_recycler.setAdapter(statusListAdapter);
