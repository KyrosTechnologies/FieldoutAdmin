...
public class CompletedJobsAdapter extends RecyclerView.Adapter<CompletedJobsAdapter.MyViewHolderEleven>{
    ...
    public CompletedJobsAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public CompletedJobsAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_month_jobs,parent,false);

        return new CompletedJobsAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(CompletedJobsAdapter.MyViewHolderEleven holder, int position) {
