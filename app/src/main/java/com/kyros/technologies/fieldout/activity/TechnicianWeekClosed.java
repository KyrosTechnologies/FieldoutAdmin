...
public class TechnicianWeekClosed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (commonJobsArrayList.size()!=0){
                ...
                CompletedJobsAdapter completedJobsAdapter = new CompletedJobsAdapter(TechnicianWeekClosed.this, commonJobsArrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                TechnicianWeekClosed.this.finish();
                return true;
        }
