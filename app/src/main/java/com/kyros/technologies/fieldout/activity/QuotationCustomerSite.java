...
public class QuotationCustomerSite extends AppCompatActivity {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<array.length();i++){
                        ...
                        QuotationCustomerSite.this.cusid=customerid;
                    ...
                    ArrayAdapter<String> adapter=new  ArrayAdapter<String>(QuotationCustomerSite.this,android.R.layout.simple_spinner_item,
                            spinnerlist);
                    adapter.setDropDownViewResource(android.R.layout.simple_list_item_1);
                    incoices_customer_spinner.setPrompt("Customer");
                    incoices_customer_spinner.setAdapter(adapter);
                    incoices_customer_spinner.setAdapter(new SpinnerDetails(adapter,R.layout.customer,QuotationCustomerSite.this));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<array.length();i++){
                        ...
                        QuotationCustomerSite.this.siteid=siteid;
                    ...
                    incoices_site_spinner.setAdapter(new SpinnerDetails(adapter,R.layout.site,QuotationCustomerSite.this));
    ...
    private void showProgressDialog() {
        if (pDialog == null) {
            pDialog = new ProgressDialog(QuotationCustomerSite.this);
    ...
    private void QuotationsAddApi() {
        String tag_json_obj = "json_obj_req";
        String url = EndURL.URL+"quotations/add";
        store= PreferenceManager.getInstance(getApplicationContext());
        Log.d("waggonurl", url);
        showProgressDialog();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        Intent i=new Intent(QuotationCustomerSite.this,AddQuotationsListActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                QuotationCustomerSite.this.finish();
                return true;
