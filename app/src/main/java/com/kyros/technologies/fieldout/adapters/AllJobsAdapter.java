...
public class AllJobsAdapter extends RecyclerView.Adapter<AllJobsAdapter.MyViewHolderEleven>{
    ...
    public AllJobsAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public AllJobsAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_month_jobs,parent,false);

        return new AllJobsAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(AllJobsAdapter.MyViewHolderEleven holder, int position) {
