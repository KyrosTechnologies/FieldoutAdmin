...
import com.example.rohin.fieldoutadmin.activity.ScheduleDayDetails;
...
public class ScheduleDayAdapter extends RecyclerView.Adapter<ScheduleDayAdapter.MyViewHolderEleven>{
    ...
    public ScheduleDayAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public ScheduleDayAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_week_schedule,parent,false);

        return new ScheduleDayAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(ScheduleDayAdapter.MyViewHolderEleven holder, int position) {
