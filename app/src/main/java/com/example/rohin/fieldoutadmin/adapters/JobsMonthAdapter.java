...
import com.example.rohin.fieldoutadmin.activity.JobsMonthDetails;
...
public class JobsMonthAdapter extends RecyclerView.Adapter<JobsMonthAdapter.MyViewHolderEleven>{
    ...
    public JobsMonthAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public JobsMonthAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_month_jobs,parent,false);

        return new JobsMonthAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(JobsMonthAdapter.MyViewHolderEleven holder, int position) {
