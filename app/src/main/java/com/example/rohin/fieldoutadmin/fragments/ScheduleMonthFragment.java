...
import com.example.rohin.fieldoutadmin.adapters.ScheduleMonthAdapter;
...
public class ScheduleMonthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        month=inflater.inflate(R.layout.fragment_week_schedule,container,false);
        week_recycler=month.findViewById(R.id.week_recycler);
        no_jobs_linear=month.findViewById(R.id.no_jobs_linear);
        add_jobs_schedule=month.findViewById(R.id.add_jobs_schedule);
    ...
    private void PutMonthCalendarList() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (commonJobsArrayList.size()!=0){
                        ...
                        ScheduleMonthAdapter monthAdapter = new ScheduleMonthAdapter(getContext(), commonJobsArrayList);
                        week_recycler.setAdapter(monthAdapter);
