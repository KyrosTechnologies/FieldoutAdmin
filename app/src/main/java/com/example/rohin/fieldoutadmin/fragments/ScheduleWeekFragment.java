...
import com.example.rohin.fieldoutadmin.adapters.ScheduleWeekAdapter;
...
public class ScheduleWeekFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        week=inflater.inflate(R.layout.fragment_week_schedule,container,false);
        week_recycler=week.findViewById(R.id.week_recycler);
        no_jobs_linear=week.findViewById(R.id.no_jobs_linear);
        add_jobs_schedule=week.findViewById(R.id.add_jobs_schedule);
    ...
    private void PutWeekCalendarList() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (commonJobsArrayList.size()!=0){
                        ...
                        ScheduleWeekAdapter scheduleWeekAdapter = new ScheduleWeekAdapter(getContext(), commonJobsArrayList);
                        week_recycler.setAdapter(scheduleWeekAdapter);
                        scheduleWeekAdapter.notifyDataSetChanged();
