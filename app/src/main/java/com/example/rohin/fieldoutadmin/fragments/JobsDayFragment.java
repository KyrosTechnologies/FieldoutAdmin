...
import com.example.rohin.fieldoutadmin.adapters.JobsDayAdapter;
...
public class JobsDayFragment extends Fragment {

    private View jobsday;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        jobsday=inflater.inflate(R.layout.fragment_month_jobs,container,false);
        jobs_month_recycler=jobsday.findViewById(R.id.jobs_month_recycler);
        no_monthjobs_linear=jobsday.findViewById(R.id.no_monthjobs_linear);
        add_jobs_day=jobsday.findViewById(R.id.add_jobs_day);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (commonJobsArrayList.size()!=0){
                        ...
                        JobsDayAdapter jobsDayAdapter = new JobsDayAdapter(getContext(), commonJobsArrayList);
                        jobs_month_recycler.setAdapter(jobsDayAdapter);
                        jobsDayAdapter.notifyDataSetChanged();
