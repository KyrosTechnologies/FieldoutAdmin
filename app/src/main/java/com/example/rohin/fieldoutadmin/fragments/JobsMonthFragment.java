...
import com.example.rohin.fieldoutadmin.adapters.JobsMonthAdapter;
...
public class JobsMonthFragment extends Fragment {

    private View jobsmonth;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        jobsmonth=inflater.inflate(R.layout.fragment_month_jobs,container,false);
        jobs_month_recycler=jobsmonth.findViewById(R.id.jobs_month_recycler);
        no_monthjobs_linear=jobsmonth.findViewById(R.id.no_monthjobs_linear);
        add_jobs_day=jobsmonth.findViewById(R.id.add_jobs_day);
    ...
    private void PutJobsMonthList() {
        String tag_json_obj = "json_obj_req";
        String url = EndURL.URL+"userjobs/getAMonthJobsByDate/"+domainid;
        Log.d("waggonurl", url);
        //showProgressDialog();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (commonJobsArrayList.size()!=0){
                        ...
                        JobsMonthAdapter jobsMonthAdapter = new JobsMonthAdapter(getContext(), commonJobsArrayList);
                        jobs_month_recycler.setAdapter(jobsMonthAdapter);
                        jobsMonthAdapter.notifyDataSetChanged();
