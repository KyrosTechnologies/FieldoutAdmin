...
import com.example.rohin.fieldoutadmin.activity.ScheduleMonthDetails;
...
public class ScheduleMonthAdapter extends RecyclerView.Adapter<ScheduleMonthAdapter.MyViewHolderEleven>{
    ...
    public ScheduleMonthAdapter(Context mContext, ArrayList<CommonJobs>duration){
    ...
    @Override
    public ScheduleMonthAdapter.MyViewHolderEleven onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_frag_week_schedule,parent,false);

        return new ScheduleMonthAdapter.MyViewHolderEleven(view);
    }

    @Override
    public void onBindViewHolder(ScheduleMonthAdapter.MyViewHolderEleven holder, int position) {
        ...
        holder.week_jobs_card.setOnClickListener(view -> {
            Intent i=new Intent(mContext, ScheduleMonthDetails.class);
